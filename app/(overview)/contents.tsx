        ...
        <div className="myGridMainPage">
            ...
            style={{ backgroundColor: 'rgba(158, 158, 158, 0.3)' }}>
                <div className={`${lusitana.className} text-black text-2xl dark:text-white`}>
                    ...
                    <div className='w-full flex justify-center gap-5 mt-5 flex-wrap'>
                        <div className={`
                        min-w-16 min-h-16 lg:w-28 lg:h-28
                        `}>
                            <svg className={`
                            p-3
                        ...
                        <div className={`
                        min-w-16 min-h-16 max-w-16 max-h-16 
                        lg:w-28 lg:h-28 lg:max-w-28 lg:max-h-28
                        `}>
                            <div className={`
                                ...
                                <img
                                        className={`hover:scale-105 cursor-pointer w-full h-full`}
                                            style={{
                                            objectFit: 'cover',
                                            }}
